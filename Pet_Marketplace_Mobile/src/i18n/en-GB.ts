export const enGB = {
  ...
  "access.addressRequired.action": "Add your address",
  "access.addressRequired.body":
    "Add a default address with your postcode so we can show providers near you and how far away each one is.",
  "access.addressRequired.title": "Address needed",
  ...
  "search.count.addressRequired": "Add your address to search",
  ...
  "book.action.cancel": "Cancel request",
  "book.action.complete": "Complete care",
  "book.action.confirm": "Confirm care",
  ...
  "book.participant.petFallback": "Pet",
  "book.participant.providerFallback": "Provider",
  "book.participant.tutorFallback": "Tutor",
  "book.pagination.allLoaded": "All bookings loaded",
  "book.pagination.bookingSingular": "booking",
  "book.pagination.bookingsPlural": "bookings",
  "book.pagination.error": "More bookings could not be loaded right now.",
  "book.pagination.loadedOne": "Showing 1 booking",
  "book.pagination.loadedPrefix": "Showing",
  "book.pagination.loadedSuffix": "bookings",
  "book.pagination.loadMore": "Load more bookings",
  "book.pagination.next": "Next",
  "book.pagination.page": "Page",
  "book.pagination.previous": "Previous",
  "book.perspective.provider": "As provider",
  "book.perspective.tutor": "As tutor",
  "book.providerSchedule.confirmed": "Confirmed care",
  "book.providerSchedule.history": "Completed and cancelled",
  "book.providerSchedule.requests": "Requests",
  ...
  "book.status.label": "Status",
  "book.status.mixed": "mixed",
  "book.status.requested": "requested",
  "book.statusUpdate.error": "The booking status could not be updated.",
  "book.statusUpdate.success": "Booking updated.",
  ...
  "book.summary.hours": "Hours",
  "book.summary.perHour": "per hour",
  "book.summary.pet": "Pet",
  "book.summary.tutor": "Tutor",
  "book.summary.title": "Summary",
  "book.title": "Request booking",

  "profile.title": "Your profile",
  "profile.body": "Review your account status and preferences.",
  "profile.hero.roleTutor": "Tutor",
  "profile.hero.roleProvider": "Provider",
  "profile.hero.roleProviderPaused": "Provider · paused",
  "profile.hero.roleProviderBlocked": "Provider · blocked",
  "profile.hero.noRoles": "Set up a profile below",
  "profile.section.account": "Account",
  "profile.section.profiles": "Your profiles",
  "profile.section.providerProfile": "Provider Profile",
  "profile.section.addresses": "Addresses",
  "profile.section.pets": "Pets",
  "profile.section.accountAndLegal": "Account & legal",
  "profile.legal.terms": "Terms of service",
  "profile.legal.privacy": "Privacy policy",
  "profile.legal.openSettings": "Open Settings",
  "profile.legal.openSettingsHint":
    "Account deletion and sign out live in Settings.",
  "profile.provider.stats.rating": "Rating",
  "profile.provider.stats.reviews": "reviews",
  ...
  "profile.providerActive.label": "Care provider profile active",
  "profile.providerActive.help":
    "Switch this on only when you want tutors to find and request care from you.",
  "profile.providerBio": "Provider bio",
  "profile.providerBioPlaceholder":
    "Tell tutors about your experience with pets.",
  "profile.providerPricePerHour": "Price per hour",
  "profile.providerPublishInvalid":
    "Add a speciality and a valid hourly price before activating your provider profile.",
  "profile.providerService": "Speciality",
  "profile.providerServicePlaceholder": "Dog walking, home visits, boarding...",
  ...
  "profile.availability.error":
    "The app could not load your weekly availability.",
  "profile.availability.help":
    "Select the weekly times when tutors can request care. Changes apply to new requests only and will not cancel existing bookings.",
  "profile.availability.inactive":
    "Activate your provider profile before editing weekly availability.",
  "profile.availability.loading": "Loading weekly availability",
  "profile.availability.save": "Save availability",
  "profile.availability.summary": "Weekly care request times",
  "profile.availability.title": "Weekly availability",
  "profile.availabilitySaveError":
    "The app could not save your weekly availability.",
  "profile.availabilitySaveSuccess": "Weekly availability saved",
  ...
  "profile.petsSummary.empty": "No pets yet",
  "profile.petsSummary.loading": "Pets",
  "profile.petsSummary.many": "{count} pets",
  "profile.petsSummary.one": "1 pet",
  ...
  "profile.pet.sheet.title": "Add pet",
  "profile.pet.sheet.titleEdit": "Edit pet",
  "profile.pet.sheet.close": "Close",
  "profile.pet.field.species": "Species",
  "profile.pet.field.breed": "Breed",
  "profile.pet.field.size": "Size",
  "profile.pet.field.ageRange": "Age",
  "profile.pet.field.notes": "Notes",
  "profile.pet.placeholder.breed": "e.g. Labrador",
  "profile.pet.placeholder.ageRange": "e.g. 3 years",
  "profile.pet.placeholder.notes":
    "Health, behaviour or anything a sitter should know",
  "profile.pet.help.notes":
    "Up to 2000 characters. Shared only with providers you book.",
  "profile.pet.size.small": "Small",
  "profile.pet.size.medium": "Medium",
  "profile.pet.size.large": "Large",
  "profile.pet.size.giant": "Giant",
  "profile.pet.size.unknown": "Unknown",
  "profile.pet.save": "Save pet",
  "profile.pet.update": "Update pet",
